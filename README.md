...
A newly generated Learning Session stores its Topic Category, canonical Learning Objective identity, Lesson Topic, cultural note, and structured Lesson Key Phrases in server-owned planned-session metadata before the generation response succeeds.
