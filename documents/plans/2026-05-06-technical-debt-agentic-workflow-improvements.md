...
**Status:** Partially complete via the progress-page view-model helper slice in commit `chore: extract progress view model helpers`; remaining candidate extractions are optional.
