...
- [ ] Task 2 — Add deterministic Coverage Evidence builder: full parseable AI history, normalized phrase/topic identities, category rotation selection, and review candidates.
- [ ] Task 3 — Wire Coverage Evidence and Learning Journal into session generation prompt/input with selected category rails.
