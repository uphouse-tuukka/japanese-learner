...
- The application must select a stable fresh transfer-context rail that was absent from the original treatment, and the generated transfer task must begin with the rail's app-owned affirmative context prefix without negating it.
