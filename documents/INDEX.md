...
- Status: planning
- Description: Broad internal technical-debt plan. Partially implemented through the Task 7.2 public-challenge facade extraction; check task checkboxes and current code before executing any lane.
- Source files affected: docs/workflow, tooling/CI, shared validators/helpers, DB internals, AI internals including `src/lib/server/ai-public-challenge.ts`, API/profile boundaries, UI modularization
