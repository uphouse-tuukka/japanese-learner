...
export const MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    name: 'Ink Apprentice',
    nameJa: '墨見習い',
    description: 'You are building steady rhythm with every practice line.',
    xpThreshold: 100,
  },
  {
    key: 'ink_250',
    name: 'Steady Hand',
    nameJa: '安定の筆',
    description: 'Your strokes are more controlled and consistent.',
    xpThreshold: 250,
  },
  {
    key: 'ink_500',
    name: 'Flowing Brush',
    nameJa: '流麗の筆',
    description: 'Practice now flows naturally like wet ink on washi.',
    xpThreshold: 500,
  },
  {
    key: 'ink_1000',
    name: 'Ink Master',
    nameJa: '墨の達人',
    description: 'A strong foundation has turned repetition into mastery.',
    xpThreshold: 1000,
  },
  {
    key: 'ink_2500',
    name: 'Calligrapher',
    nameJa: '書道家',
    description: 'Your dedication shows precision, calm, and command.',
    xpThreshold: 2500,
  },
  {
    key: 'ink_5000',
    ...
    nameJa: '人間国宝',
    description: 'A rare level of consistency worthy of reverence.',
    xpThreshold: 5000,
  },
];
