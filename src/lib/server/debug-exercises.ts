  ...
  fill_blank: [
    {
      ...
      japanese: '毎朝、____を飲みます。',
      romaji: 'Maiasa, ____ o nomimasu.',
      ...
      sentenceEnglish: 'Every morning, I drink coffee.',
      blank: '____',
      answer: 'コーヒー',
      answerRomaji: 'Koohii',
    },
  ...
  speaking: [
    {
      ...
      japanese: 'トイレはどこですか。',
      romaji: 'Toire wa doko desu ka.',
      englishContext: 'You are in a station and need to ask where the restroom is.',
      tags: ['travel', 'directions', 'speaking'],
      difficulty: 2,
      prompt: 'Speak Japanese to ask: Where is the restroom?',
      responseKind: 'situational_response',
      expectedAnswer: 'トイレはどこですか。',
      expectedRomaji: 'Toire wa doko desu ka.',
      acceptedAnswers: ['トイレはどこですか。', 'お手洗いはどこですか。'],
      rubric: 'Accept a polite Japanese question asking where the restroom or toilet is.',
      maxRecordingSeconds: 12,
    },
    {
      type: 'speaking',
      title: 'Say you want water',
      japanese: '水をください。',
      romaji: 'Mizu o kudasai.',
      englishContext: 'You are at a restaurant and want water.',
      tags: ['daily_life', 'restaurant', 'speaking'],
      difficulty: 2,
      prompt: 'Speak Japanese for: Please give me water.',
      responseKind: 'translation_en_to_ja',
      expectedAnswer: '水をください。',
      expectedRomaji: 'Mizu o kudasai.',
      acceptedAnswers: ['水をください。', 'お水をください。'],
      rubric: 'Accept a natural Japanese request for water, with or without polite お.',
