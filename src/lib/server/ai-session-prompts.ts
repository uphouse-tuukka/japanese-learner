...
const EXERCISE_FIELD_REQUIREMENTS: Record<NonTranslationExerciseType, string> = {
  ...
  fill_blank:
    '- fill_blank: sentence, sentenceRomaji, sentenceEnglish, blank, answer, answerRomaji. For fill_blank exercises, sentence and sentenceRomaji must contain the visible placeholder "____" where the missing answer goes, and must not include the answer itself. Set blank to "____".',
