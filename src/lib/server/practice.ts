...
function pickTopExercises(candidates: CandidateExercise[], target: number): Exercise[] {
return candidates
.slice()
.sort((a, b) => {
...
throw new Error('No completed AI sessions found yet. Finish at least one AI learning session before practice mode.');
}
