...
if (level === 'total-beginner') return 'Total Beginner';
if (level === 'knows-something') return 'Knows Something';
...
<legend>Level</legend>
<label><input type="radio" name="level" value="total-beginner" checked /> Total beginner</label>
<label><input type="radio" name="level" value="knows-something" /> Knows something</label>
...
<div class="dashboard">
<article class="card block">
<h1>こんにちは、{data.selectedUser.display_name}さん</h1>
